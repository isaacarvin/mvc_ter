...
variable "res_storage_data_create_option" {
  type        = string
  description = "Create Option for the Storage Data Disk"
  default     = "Empty"
}
...
variable "res_bkup_vault_rg_name" {
  type        = string
  description = "Compute Windows: Backup Vault Resource Group Name"
}

variable "res_bkup_vault_name" {
  type        = string
  description = "Compute Windows: Backup Vault Name"
}

variable "res_bkup_vault_policy_id" {
  type        = string
  description = "Compute Windows: Backup Vault Policy ID"
}

variable "res_kv_vault_id" {
  type        = string
  description = "Compute Windows: Key Vault Vault ID"
}
